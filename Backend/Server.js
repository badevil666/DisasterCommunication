...
const getContactDetails = require('./Routes/User/getContactDetails')
const getVolunteerGuidelines = require('./Routes/User/getVolunteerGuidelines')
const getNearbyUsers = require('./Routes/Authority/getNearbyUsers')
const getJoinedVolunteers = require('./Routes/Authority/getJoinedVolunteers')
const addVolunteerGuideline = require('./Routes/Authority/addVolunteerGuideline')
...
app.use('/getContactDetails', getContactDetails)
app.use('/getVolunteerGuidelines', getVolunteerGuidelines)
app.use('/getNearbyUsers', getNearbyUsers)
app.use('/getJoinedVolunteers', getJoinedVolunteers)
app.use('/addVolunteerGuideline', addVolunteerGuideline)
app.get('/', (req, res) => {
